...
const s = {
  ...
  perfilNombre: { color: "#e8eaf0", fontWeight: 700, fontSize: "1rem" },
  perfilEmail:  { color: "#6b7280", fontSize: "0.82rem", marginTop: 2 },
  perfilBadge:  { fontSize: "0.75rem", color: "#9ca3af", marginTop: 4 },
  ...
  emailValue: { color: "#9ca3af", fontSize: "0.88rem", flex: 1 },
  ...
  infoRow: {
    ...
    alignItems:     "center",
    padding:        "6px 0",
    borderBottom:   "1px solid #2e335233",
  },
  infoKey: { color: "#6b7280", fontSize: "0.8rem" },
  infoVal: { color: "#9ca3af", fontSize: "0.8rem", fontWeight: 500 },
};
